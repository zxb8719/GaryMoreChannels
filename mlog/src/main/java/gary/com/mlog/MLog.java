...
public class MLog {
    ...
    public static  final String showTag = "gary===";
    ...
    public static void llog(int type, String tagStr, Object obj) {
        ...
        stringBuilder.append("["+showTag+"][ (").append(className).append(":").append(lineNumber).append(")#").append(methodName).append(" ] ");
